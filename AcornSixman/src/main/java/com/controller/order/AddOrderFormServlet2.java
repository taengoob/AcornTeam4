...
/**
 * Servlet implementation class AddOrderFormServlet2
 */
@WebServlet("/AddOrderFormServlet2")
public class AddOrderFormServlet2 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AddOrderFormServlet2() {
        super();
