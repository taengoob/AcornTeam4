						...
						%>
							<td>
								<table style='padding:15px'>
									<tr>
										<td>
											<a href="GoodsRetrieveServlet?gCode=<%= product.getProductId() %>"><!-- 이미지링크 --> 
												<img src="<%= product.getPreviewUrl() %>" border="0" align="center" width="200">
											</a>
										</td>
									</tr>
									<tr>
									...
									<tr>
										<td class= "td_default" align ="center">
											<a class= "a_black" href=""><%= product.getProductName() %><br></a>
											<font color="gray">
											 --------------------
											</font>
										</td>
