...
<script type="text/javascript">
	...
	function replyAdd() {//댓글 추가
		var ContentId = document.getElementById("RealContentId").value;
	...
	function showHtml(data) {
		...
		$.each(data, function(i, ele) {
			...
			html += '<div class="col-sm-2" style="height: 60px; width: 60px; background-color: pink; margin-left: 30px;"></div>'
			html += '<div class="col-sm-2" style="height: 60px; width: 120px; text-align: center; line-height: 60px;">닉네임</div>'
			html += '<div class="col-sm-6" style="width: 780px;">'
			html += 'line-height:line-height:line-height:line-height:line-height:line-height:line-height:line-height:line-height:line-height:li'
			html += '</div><div class="col-sm-2" style="width: 190px; right: -10px;">'
			html += '<a class="btn btn-outline-secondary btn-sm" id="replybtn1">삭제</a>'
			html += '<a class="btn btn-outline-secondary btn-sm" id="replybtn2">수정</a>'
			html += '<a class="btn btn-outline-secondary btn-sm" id="replybtn3">답글</a>'
			html += '<span style="float: right;"><br>2022/08/15 16:33:24</span></div></div>'
		})
