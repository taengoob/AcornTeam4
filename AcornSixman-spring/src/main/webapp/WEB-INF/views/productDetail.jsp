...
<html>
  <head>
    ...
    <% request.setCharacterEncoding("utf-8"); String mesg = (String) session.getAttribute("memberupdate"); String logout = (String) session.getAttribute("logout"); if (mesg != null) { %>
  ...
  <body>
    ...
    <div class="wide"></div>
    <jsp:include page="product/productDetail.jsp"></jsp:include>
