...
<html>
	...
	<body>
		...
		<form action="/imageUploadTest" method="post" enctype="multipart/form-data">
			<h4>제품명</h4>
			<input type="text" name="productName" value="" id="productName" />

			<h4>가격</h4>
			<input type="number" name="productPrice" value="0" id="productPrice" />
		...
		<!-- <form action="imageUploadTest" method="post" enctype="multipart/form-data" id="imageForm">
			<table border="1">
				<tr>
					<th>제품명</th>
