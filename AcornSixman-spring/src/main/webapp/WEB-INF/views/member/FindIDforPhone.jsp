  ...
  <body>
      ...
      <div class="main-box">
        <form action="FindPhone" method="post" id="mainform">
          ...
          <div class="login-input">
            <input type="text" class="form-control" style="width: 40%" id="name" name="accountName" placeholder="이름" />&nbsp;&nbsp; <span class="name-result"></span>

            <section class="call-number-container">
              <p class="number-item1"><span class="xi-checkbox-blank"></span> 휴대폰번호</p>
              <input type="text" placeholder="- 없이 입력하세요." data-pattern="gdNum" style="width: 40%" class="form-control" id="phoneNumber" name="accountPhone" onkeyup="checkNumber(event)" />
            </section>
    ...
    <script type="text/javascript">
      ...
      function checkNumber(event) {
        ...
        if ((event.key >= 0 && event.key <= 9) || event.keyCode == 8 || event.keyCode == 9 || event.keyCode == 13) {
          return true;
        } else {
          alert("숫자만 입력해야 합니다.");
