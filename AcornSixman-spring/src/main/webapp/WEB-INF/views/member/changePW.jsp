			...
			<div class="main-box">
				<form action="ChangePasswd" method="post" id="mainform">
					...
					<div class="login-input">
						<div class="mb-3">
							<input type="hidden" id="userid" name="accountId" value="<%=dto%>" />
							<input type="password" class="form-control" id="passwd1" name="accountPasswd" placeholder="새 비밀번호" /> <span class="passwd1-result"></span>
						</div>
						&nbsp;&nbsp; <span class="name-result"></span> <br />
						<input type="password" class="form-control" name="passwd2" id="passwd2" placeholder="비밀번호 확인" /> <br />
						<span class="passwd2-result"></span>
					</div>
					<br />

					<button type="submit" class="btn btn-outline-primary" id="submit">비밀번호 변경</button>
					<br />
					<br />
